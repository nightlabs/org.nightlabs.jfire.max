...
implements Serializable, ObjectID
{
	...
	public String toString() 
	{
		...
		try {
			...
			sb.append(URLEncoder.encode(Long.toString(moneyFlowConfigID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(organisationID == null) {
			...
			return false;
		if(moneyFlowConfigID != other.moneyFlowConfigID)
			return false;
		return true;
	}
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static DunningMoneyFlowConfigID create(String organisationID, long dunningMoneyFlowConfigID)
	{
		DunningMoneyFlowConfigID n = new DunningMoneyFlowConfigID();
		n.organisationID = organisationID;
		n.moneyFlowConfigID = dunningMoneyFlowConfigID;
		return n;
	}
}
