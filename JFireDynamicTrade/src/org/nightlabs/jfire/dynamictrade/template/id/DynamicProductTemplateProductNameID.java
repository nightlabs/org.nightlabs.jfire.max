...
package org.nightlabs.jfire.dynamictrade.template.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.dynamictrade.template.DynamicProductTemplateProductName}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class DynamicProductTemplateProductNameID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.dynamictrade.template.DynamicProductTemplateProductName}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field dynamicProductTemplateID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.dynamictrade.template.DynamicProductTemplateProductName}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long dynamicProductTemplateID;

	/**
	 * Create a new empty instance of DynamicProductTemplateProductNameID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public DynamicProductTemplateProductNameID()
	{
	}

	/**
	 * Create a new instance of DynamicProductTemplateProductNameID.
	 ...
	 * <code>DynamicProductTemplateProductNameID newDynamicProductTemplateProductNameID = new DynamicProductTemplateProductNameID(oldDynamicProductTemplateProductNameID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public DynamicProductTemplateProductNameID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends DynamicProductTemplateProductNameID> clazz = this.getClass();
	 ...
	 * {@link #DynamicProductTemplateProductNameID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("dynamicProductTemplateID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(dynamicProductTemplateID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		DynamicProductTemplateProductNameID other = (DynamicProductTemplateProductNameID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(dynamicProductTemplateID != other.dynamicProductTemplateID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + (int) (dynamicProductTemplateID ^ (dynamicProductTemplateID >>> 32));
		return result;
	}
	 ...
	 * @param dynamicProductTemplateID The primary key field dynamicProductTemplateID.
	 * @return a newly created instance of <code>DynamicProductTemplateProductNameID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static DynamicProductTemplateProductNameID create(String organisationID, long dynamicProductTemplateID)
	{
		DynamicProductTemplateProductNameID n = new DynamicProductTemplateProductNameID();
		n.organisationID = organisationID;
		n.dynamicProductTemplateID = dynamicProductTemplateID;
		return n;
	}
}
