...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.issue.IssueLinkTypeName}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class IssueLinkTypeNameID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -2199098364710519699L;
	...
	/**
	 * Primary key field issueLinkTypeID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.issue.IssueLinkTypeName}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String issueLinkTypeID;
	...
	/**
	 * Create a new empty instance of IssueLinkTypeNameID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public IssueLinkTypeNameID()
	{
	}

	/**
	 * Create a new instance of IssueLinkTypeNameID.
	 ...
	 * <code>IssueLinkTypeNameID newIssueLinkTypeNameID = new IssueLinkTypeNameID(oldIssueLinkTypeNameID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public IssueLinkTypeNameID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends IssueLinkTypeNameID> clazz = this.getClass();
	 ...
	 * {@link #IssueLinkTypeNameID(String)}.
	...
	public String toString()
	{
		...
		try {
			sb.append("issueLinkTypeID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(issueLinkTypeID), ENCODING));
			sb.append('&');
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		IssueLinkTypeNameID other = (IssueLinkTypeNameID) obj;
		if(issueLinkTypeID == null) {
			if(other.issueLinkTypeID != null)
				return false;
		} else if(!issueLinkTypeID.equals(other.issueLinkTypeID))
			return false;
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + ((issueLinkTypeID == null) ? 0 : issueLinkTypeID.hashCode());
	 ...
	 * @param issueLinkTypeID The primary key field issueLinkTypeID.
	 * @param organisationID The primary key field organisationID.
	 * @return a newly created instance of <code>IssueLinkTypeNameID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static IssueLinkTypeNameID create(String issueLinkTypeID, String organisationID)
	{
		IssueLinkTypeNameID n = new IssueLinkTypeNameID();
		n.issueLinkTypeID = issueLinkTypeID;
