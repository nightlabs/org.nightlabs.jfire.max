...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.issue.IssueReminder}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class IssueReminderID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.issue.IssueReminder}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field issueReminderID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.issue.IssueReminder}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long issueReminderID;

	/**
	 * Create a new empty instance of IssueReminderID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public IssueReminderID()
	{
	}

	/**
	 * Create a new instance of IssueReminderID.
	 ...
	 * <code>IssueReminderID newIssueReminderID = new IssueReminderID(oldIssueReminderID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public IssueReminderID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends IssueReminderID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("issueReminderID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(issueReminderID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		IssueReminderID other = (IssueReminderID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(issueReminderID != other.issueReminderID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + (int) (issueReminderID ^ (issueReminderID >>> 32));
		return result;
	}
	 ...
	 * @param issueReminderID The primary key field issueReminderID.
	 * @return a newly created instance of <code>IssueReminderID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static IssueReminderID create(String organisationID, long issueReminderID)
	{
		IssueReminderID n = new IssueReminderID();
		n.organisationID = organisationID;
		n.issueReminderID = issueReminderID;
		return n;
	}
}
