...
package org.nightlabs.jfire.reporting.scheduled.id;
...
/**
 * The JDO object id class for {@link ScheduledReport}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class ScheduledReportDeliveryDelegateEMailID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.parameter.config.ScheduledReport}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field deliveryDelegateID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.parameter.config.ScheduledReport}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long deliveryDelegateID;

	/**
	 * Create a new empty instance of ScheduledReportDeliveryDelegateEMailID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ScheduledReportDeliveryDelegateEMailID()
	{
	}

	/**
	 * Create a new instance of ScheduledReportDeliveryDelegateEMailID.
	 ...
	 * <code>ScheduledReportDeliveryDelegateEMailID newScheduledReportDeliveryDelegateEMailID = new ScheduledReportDeliveryDelegateEMailID(oldScheduledReportDeliveryDelegateEMailID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ScheduledReportDeliveryDelegateEMailID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ScheduledReportDeliveryDelegateEMailID> clazz = this.getClass();
	 ...
	 * {@link #ScheduledReportDeliveryDelegateEMailID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("deliveryDelegateID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(deliveryDelegateID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ScheduledReportDeliveryDelegateEMailID other = (ScheduledReportDeliveryDelegateEMailID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(deliveryDelegateID != other.deliveryDelegateID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + (int) (deliveryDelegateID ^ (deliveryDelegateID >>> 32));
		return result;
	}
	 ...
	 * @param deliveryDelegateID The primary key field deliveryDelegateID.
	 * @return a newly created instance of <code>ScheduledReportDeliveryDelegateEMailID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ScheduledReportDeliveryDelegateEMailID create(String organisationID, long scheduledReportDeliveryDelegateEMailID)
	{
		ScheduledReportDeliveryDelegateEMailID n = new ScheduledReportDeliveryDelegateEMailID();
		n.organisationID = organisationID;
		n.deliveryDelegateID = scheduledReportDeliveryDelegateEMailID;
		return n;
	}
}
