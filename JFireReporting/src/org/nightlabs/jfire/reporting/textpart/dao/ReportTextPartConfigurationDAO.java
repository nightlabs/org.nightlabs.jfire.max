...
public class ReportTextPartConfigurationDAO extends BaseJDOObjectDAO<ReportTextPartConfigurationID, ReportTextPartConfiguration> {
	...
	protected Collection<ReportTextPartConfiguration> retrieveJDOObjects(
		...
		ReportTextPartManagerRemote rtpm = getReportTextPartManager();
		monitor.worked(1);
	...
	public ReportTextPartConfiguration getReportTextPartConfiguration(
		...
		result = rtpm.getReportTextPartConfiguration(reportRegistryItemID, linkedObjectID, synthesize, fetchGroups, maxFetchDepth);
		monitor.done();
		return result;
	}
	...
	public ReportTextPartConfiguration getReportTextPartConfiguration(
		...
		monitor.worked(1);
		ReportTextPartConfiguration result = null;
		result = rtpm.getReportTextPartConfiguration(reportRegistryItemID, synthesize, fetchGroups, maxFetchDepth);
		monitor.done();
		return result;
	}
