...
package org.nightlabs.jfire.reporting.textpart.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.reporting.textpart.ReportTextPartContent}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class ReportTextPartContentID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = 771169252793119052L;
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.textpart.ReportTextPartContent}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field reportTextPartConfigurationID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.textpart.ReportTextPartContent}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long reportTextPartConfigurationID;

	/**
	 * Primary key field reportTextPartID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.textpart.ReportTextPartContent}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String reportTextPartID;

	/**
	 * Create a new empty instance of ReportTextPartContentID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ReportTextPartContentID()
	{
	}

	/**
	 * Create a new instance of ReportTextPartContentID.
	 ...
	 * <code>ReportTextPartContentID newReportTextPartContentID = new ReportTextPartContentID(oldReportTextPartContentID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ReportTextPartContentID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ReportTextPartContentID> clazz = this.getClass();
	 ...
	 * {@link #ReportTextPartContentID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("reportTextPartConfigurationID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(reportTextPartConfigurationID, RADIX), ENCODING));
			sb.append('&');
			sb.append("reportTextPartID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(reportTextPartID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ReportTextPartContentID other = (ReportTextPartContentID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(reportTextPartConfigurationID != other.reportTextPartConfigurationID)
			return false;
		if(reportTextPartID == null) {
			if(other.reportTextPartID != null)
				return false;
		} else if(!reportTextPartID.equals(other.reportTextPartID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + (int) (reportTextPartConfigurationID ^ (reportTextPartConfigurationID >>> 32));
		result = prime * result + ((reportTextPartID == null) ? 0 : reportTextPartID.hashCode());
		return result;
	}
	 ...
	 * @param reportTextPartConfigurationID The primary key field reportTextPartConfigurationID.
	 * @param reportTextPartID The primary key field reportTextPartID.
	 * @return a newly created instance of <code>ReportTextPartContentID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ReportTextPartContentID create(String organisationID, long reportTextPartConfigurationID, String reportTextPartID)
	{
		ReportTextPartContentID n = new ReportTextPartContentID();
		n.organisationID = organisationID;
		n.reportTextPartConfigurationID = reportTextPartConfigurationID;
		n.reportTextPartID = reportTextPartID;
		return n;
	}
}
