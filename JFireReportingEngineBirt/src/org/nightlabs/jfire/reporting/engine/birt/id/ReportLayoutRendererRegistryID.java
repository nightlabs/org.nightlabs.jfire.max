...
package org.nightlabs.jfire.reporting.engine.birt.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.reporting.engine.birt.ReportLayoutRendererRegistry}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class ReportLayoutRendererRegistryID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -1946596378027021691L;
	...
	/**
	 * Primary key field registryID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.engine.birt.ReportLayoutRendererRegistry}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public int registryID;

	/**
	 * Create a new empty instance of ReportLayoutRendererRegistryID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ReportLayoutRendererRegistryID()
	{
	}

	/**
	 * Create a new instance of ReportLayoutRendererRegistryID.
	 ...
	 * <code>ReportLayoutRendererRegistryID newregistryID = new ReportLayoutRendererRegistryID(oldregistryID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ReportLayoutRendererRegistryID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ReportLayoutRendererRegistryID> clazz = this.getClass();
	 ...
	 * {@link #ReportLayoutRendererRegistryID(String)}.
	...
	public String toString()
	{
		...
		try {
			sb.append("registryID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Integer.toString(registryID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ReportLayoutRendererRegistryID other = (ReportLayoutRendererRegistryID) obj;
		if(registryID != other.registryID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + registryID;
		return result;
	}

	/**
	 * Create a new object id instance.
	 * @param registryID The primary key field registryID.
	 * @return a newly created instance of <code>ReportLayoutRendererRegistryID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ReportLayoutRendererRegistryID create(int registryID)
	{
		ReportLayoutRendererRegistryID n = new ReportLayoutRendererRegistryID();
