...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.scripting.ScriptParameter}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class ScriptParameterID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -503273309772058942L;
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.scripting.ScriptParameter}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field scriptParameterSetID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.scripting.ScriptParameter}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long scriptParameterSetID;

	/**
	 * Primary key field scriptParameterID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.scripting.ScriptParameter}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String scriptParameterID;

	/**
	 * Create a new empty instance of ScriptParameterID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	...
	/**
	 * Create a new instance of ScriptParameterID.
	 ...
	 * <code>ScriptParameterID newScriptParameterID = new ScriptParameterID(oldScriptParameterID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ScriptParameterID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ScriptParameterID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("scriptParameterSetID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(scriptParameterSetID, RADIX), ENCODING));
			sb.append('&');
			sb.append("scriptParameterID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(scriptParameterID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ScriptParameterID other = (ScriptParameterID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(scriptParameterSetID != other.scriptParameterSetID)
			return false;
		if(scriptParameterID == null) {
			if(other.scriptParameterID != null)
				return false;
		} else if(!scriptParameterID.equals(other.scriptParameterID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + (int) (scriptParameterSetID ^ (scriptParameterSetID >>> 32));
		result = prime * result + ((scriptParameterID == null) ? 0 : scriptParameterID.hashCode());
		return result;
	}
	 ...
	 * @param scriptParameterSetID The primary key field scriptParameterSetID.
	 * @param scriptParameterID The primary key field scriptParameterID.
	 * @return a newly created instance of <code>ScriptParameterID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ScriptParameterID create(String organisationID, long scriptParameterSetID, String scriptParameterID)
	{
		ScriptParameterID n = new ScriptParameterID();
		n.organisationID = organisationID;
		n.scriptParameterSetID = scriptParameterSetID;
		n.scriptParameterID = scriptParameterID;
		return n;
	}
}
