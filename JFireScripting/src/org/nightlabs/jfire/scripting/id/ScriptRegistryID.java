...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.scripting.ScriptRegistry}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class ScriptRegistryID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -1946596378000185828L;
	...
	/**
	 * Primary key field scriptRegistryID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.scripting.ScriptRegistry}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public int scriptRegistryID;

	/**
	 * Create a new empty instance of ScriptRegistryID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ScriptRegistryID()
	{
	}

	/**
	 * Create a new instance of ScriptRegistryID.
	 ...
	 * <code>ScriptRegistryID newScriptRegistryID = new ScriptRegistryID(oldScriptRegistryID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ScriptRegistryID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ScriptRegistryID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			sb.append("scriptRegistryID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Integer.toString(scriptRegistryID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ScriptRegistryID other = (ScriptRegistryID) obj;
		if(scriptRegistryID != other.scriptRegistryID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + scriptRegistryID;
		return result;
	}

	/**
	 * Create a new object id instance.
	 * @param scriptRegistryID The primary key field scriptRegistryID.
	 * @return a newly created instance of <code>ScriptRegistryID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ScriptRegistryID create(int scriptRegistryID)
	{
		ScriptRegistryID n = new ScriptRegistryID();
		n.scriptRegistryID = scriptRegistryID;
		return n;
	}
}
