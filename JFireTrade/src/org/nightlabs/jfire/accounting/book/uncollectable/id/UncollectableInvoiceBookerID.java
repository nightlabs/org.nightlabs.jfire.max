...
package org.nightlabs.jfire.accounting.book.uncollectable.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.accounting.book.uncollectable.UncollectableInvoiceBooker}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class UncollectableInvoiceBookerID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -1911331023L;
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.book.uncollectable.UncollectableInvoiceBooker}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field uncollectableInvoiceBookerID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.book.uncollectable.UncollectableInvoiceBooker}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String uncollectableInvoiceBookerID;

	/**
	 * Create a new empty instance of UncollectableInvoiceBookerID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public UncollectableInvoiceBookerID()
	{
	}

	/**
	 * Create a new instance of UncollectableInvoiceBookerID.
	 ...
	 * <code>UncollectableInvoiceBookerID newUncollectableInvoiceBookerID = new UncollectableInvoiceBookerID(oldUncollectableInvoiceBookerID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public UncollectableInvoiceBookerID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends UncollectableInvoiceBookerID> clazz = this.getClass();
	 ...
	 * {@link #UncollectableInvoiceBookerID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("uncollectableInvoiceBookerID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(uncollectableInvoiceBookerID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		UncollectableInvoiceBookerID other = (UncollectableInvoiceBookerID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(uncollectableInvoiceBookerID == null) {
			if(other.uncollectableInvoiceBookerID != null)
				return false;
		} else if(!uncollectableInvoiceBookerID.equals(other.uncollectableInvoiceBookerID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + ((uncollectableInvoiceBookerID == null) ? 0 : uncollectableInvoiceBookerID.hashCode());
		return result;
	}
	 ...
	 * @param uncollectableInvoiceBookerID The primary key field uncollectableInvoiceBookerID.
	 * @return a newly created instance of <code>UncollectableInvoiceBookerID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static UncollectableInvoiceBookerID create(String organisationID, String uncollectableInvoiceBookerID)
	{
		UncollectableInvoiceBookerID n = new UncollectableInvoiceBookerID();
		n.organisationID = organisationID;
		n.uncollectableInvoiceBookerID = uncollectableInvoiceBookerID;
		return n;
	}
}
