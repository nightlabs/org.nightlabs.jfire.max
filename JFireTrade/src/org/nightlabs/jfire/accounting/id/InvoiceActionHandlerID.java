...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.accounting.InvoiceActionHandler}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class InvoiceActionHandlerID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.InvoiceActionHandler}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field invoiceActionHandlerID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.InvoiceActionHandler}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String invoiceActionHandlerID;

	/**
	 * Create a new empty instance of InvoiceActionHandlerID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public InvoiceActionHandlerID()
	{
	}

	/**
	 * Create a new instance of InvoiceActionHandlerID.
	 ...
	 * <code>InvoiceActionHandlerID newInvoiceActionHandlerID = new InvoiceActionHandlerID(oldInvoiceActionHandlerID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public InvoiceActionHandlerID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends InvoiceActionHandlerID> clazz = this.getClass();
	 ...
	 * {@link #InvoiceActionHandlerID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("invoiceActionHandlerID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(invoiceActionHandlerID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		InvoiceActionHandlerID other = (InvoiceActionHandlerID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(invoiceActionHandlerID == null) {
			if(other.invoiceActionHandlerID != null)
				return false;
		} else if(!invoiceActionHandlerID.equals(other.invoiceActionHandlerID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + ((invoiceActionHandlerID == null) ? 0 : invoiceActionHandlerID.hashCode());
		return result;
	}
	 ...
	 * @param invoiceActionHandlerID The primary key field invoiceActionHandlerID.
	 * @return a newly created instance of <code>InvoiceActionHandlerID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static InvoiceActionHandlerID create(String organisationID, String invoiceActionHandlerID)
	{
		InvoiceActionHandlerID n = new InvoiceActionHandlerID();
		n.organisationID = organisationID;
		n.invoiceActionHandlerID = invoiceActionHandlerID;
		return n;
	}
}
