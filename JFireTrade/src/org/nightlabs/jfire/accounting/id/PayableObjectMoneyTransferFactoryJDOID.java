...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.accounting.PayableObjectMoneyTransferFactoryJDO}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class PayableObjectMoneyTransferFactoryJDOID
implements Serializable
{
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.PayableObjectMoneyTransferFactoryJDO}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;
	
	/**
	 * Primary key field payableObjectType.
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.PayableObjectMoneyTransferFactoryJDO}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String payableObjectType;
	
	/**
	 * Primary key field scope.
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.PayableObjectMoneyTransferFactoryJDO}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	...
	/**
	 * Create a new empty instance of PayableObjectMoneyTransferFactoryJDOID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public PayableObjectMoneyTransferFactoryJDOID()
	{
	}

	/**
	 * Create a new instance of PayableObjectMoneyTransferFactoryJDOID.
	 ...
	 * <code>PayableObjectMoneyTransferFactoryJDOID newPayableObjectMoneyTransferFactoryJDOID = new PayableObjectMoneyTransferFactoryJDOID(oldPayableObjectMoneyTransferFactoryJDOID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public PayableObjectMoneyTransferFactoryJDOID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends PayableObjectMoneyTransferFactoryJDOID> clazz = this.getClass();
	 ...
	 * {@link #PayableObjectMoneyTransferFactoryJDOID(String)}.
	...
	public String toString() 
	{
		...
		try {
			...
			sb.append('&');
			sb.append("payableObjectType="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(payableObjectType), ENCODING));
			sb.append('&');
			sb.append("scope="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(scope), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		PayableObjectMoneyTransferFactoryJDOID other = (PayableObjectMoneyTransferFactoryJDOID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(payableObjectType == null) {
			if(other.payableObjectType != null)
				return false;
		} else if(!payableObjectType.equals(other.payableObjectType))
			return false;
		if(scope == null) {
			if(other.scope != null)
				return false;
	...
	public int hashCode()
	{
		...
		result = prime * result + ((payableObjectType == null) ? 0 : payableObjectType.hashCode());
	 ...
	 * @param payableObjectType The primary key field payableObjectType.
	 * @param scope The primary key field scope.
	 * @return a newly created instance of <code>PayableObjectMoneyTransferFactoryJDOID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static PayableObjectMoneyTransferFactoryJDOID create(String organisationID, String payableObjectType, String scope)
	{
		PayableObjectMoneyTransferFactoryJDOID n = new PayableObjectMoneyTransferFactoryJDOID();
		n.organisationID = organisationID;
		n.payableObjectType = payableObjectType;
		n.scope = scope;
		return n;
	}
}
