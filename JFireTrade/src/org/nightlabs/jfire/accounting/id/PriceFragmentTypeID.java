...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.accounting.PriceFragmentType}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class PriceFragmentTypeID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.PriceFragmentType}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field priceFragmentTypeID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.PriceFragmentType}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String priceFragmentTypeID;

	/**
	 * Create a new empty instance of PriceFragmentTypeID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public PriceFragmentTypeID()
	{
	}

	/**
	 * Create a new instance of PriceFragmentTypeID.
	 ...
	 * <code>PriceFragmentTypeID newPriceFragmentTypeID = new PriceFragmentTypeID(oldPriceFragmentTypeID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public PriceFragmentTypeID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends PriceFragmentTypeID> clazz = this.getClass();
	 ...
	 * {@link #PriceFragmentTypeID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("priceFragmentTypeID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(priceFragmentTypeID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		PriceFragmentTypeID other = (PriceFragmentTypeID) obj;
		...
		if(priceFragmentTypeID == null) {
			if(other.priceFragmentTypeID != null)
				return false;
		} else if(!priceFragmentTypeID.equals(other.priceFragmentTypeID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + ((priceFragmentTypeID == null) ? 0 : priceFragmentTypeID.hashCode());
		return result;
	}
	 ...
	 * @param priceFragmentTypeID The primary key field priceFragmentTypeID.
	 * @return a newly created instance of <code>PriceFragmentTypeID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static PriceFragmentTypeID create(String organisationID, String priceFragmentTypeID)
	{
		PriceFragmentTypeID n = new PriceFragmentTypeID();
		n.organisationID = organisationID;
		n.priceFragmentTypeID = priceFragmentTypeID;
		return n;
	}

	public String getPrimaryKey()
	{
		return org.nightlabs.jfire.accounting.PriceFragmentType.getPrimaryKey(organisationID, priceFragmentTypeID);
	}
}
