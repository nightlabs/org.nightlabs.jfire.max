...
import org.nightlabs.jfire.store.id.ProductTypeLocalMapEntryMetaDataID;
 ...
 *		objectid-class="org.nightlabs.jfire.store.id.ProductTypeLocalMapEntryMetaDataID"
 *		detachable="true"
 *		table="JFireTrade_ProductTypeLocalMapEntryMetaData"
 *
 * @jdo.create-objectid-class field-order="organisationID, productTypeID, fieldName, key"
 *
 * @jdo.inheritance strategy="new-table"
 *
 * @jdo.fetch-group name="ProductTypeLocal.fieldMetaDataMap" fields="mapFieldMetaData" fetch-groups="default"
 */
@PersistenceCapable(
	objectIdClass=ProductTypeLocalMapEntryMetaDataID.class,
...
public class ProductTypeLocalMapEntryMetaData
	implements org.nightlabs.inheritance.MapEntryMetaData, Serializable
{
	 ...
	 */
	@Persistent(persistenceModifier=PersistenceModifier.PERSISTENT)
	private ProductTypeLocalMapFieldMetaData mapFieldMetaData;

	protected ProductTypeLocalMapEntryMetaData() { }
	public ProductTypeLocalMapEntryMetaData(ProductTypeLocalMapFieldMetaData mapFieldMetaData, String key)
	{
	...
	public ProductTypeLocalMapFieldMetaData getMapFieldMetaData()
	{
