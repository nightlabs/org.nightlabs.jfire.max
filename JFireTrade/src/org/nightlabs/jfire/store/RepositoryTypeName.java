...
import org.nightlabs.jfire.store.id.RepositoryTypeNameID;
 ...
 */
@PersistenceCapable(
	objectIdClass=RepositoryTypeNameID.class,
...
@FetchGroups(
	@FetchGroup(
		...
		members={@Persistent(name="repositoryType"), @Persistent(name="names")})
)
