...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.store.book.Storekeeper}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class StorekeeperID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.store.book.Storekeeper}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field storekeeperID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.store.book.Storekeeper}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String storekeeperID;

	/**
	 * Create a new empty instance of StorekeeperID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public StorekeeperID()
	{
	}

	/**
	 * Create a new instance of StorekeeperID.
	 ...
	 * <code>StorekeeperID newStorekeeperID = new StorekeeperID(oldStorekeeperID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public StorekeeperID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends StorekeeperID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("storekeeperID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(storekeeperID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		StorekeeperID other = (StorekeeperID) obj;
		...
		if(storekeeperID == null) {
			if(other.storekeeperID != null)
				return false;
		} else if(!storekeeperID.equals(other.storekeeperID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + ((storekeeperID == null) ? 0 : storekeeperID.hashCode());
		return result;
	}
	 ...
	 * @param storekeeperID The primary key field storekeeperID.
	 * @return a newly created instance of <code>StorekeeperID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static StorekeeperID create(String organisationID, String storekeeperID)
	{
		StorekeeperID n = new StorekeeperID();
		n.organisationID = organisationID;
		n.storekeeperID = storekeeperID;
		return n;
	}
}
