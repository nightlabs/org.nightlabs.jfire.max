...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.store.DeliveryNoteActionHandler}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class DeliveryNoteActionHandlerID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.store.DeliveryNoteActionHandler}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field deliveryNoteActionHandlerID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.store.DeliveryNoteActionHandler}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String deliveryNoteActionHandlerID;

	/**
	 * Create a new empty instance of DeliveryNoteActionHandlerID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public DeliveryNoteActionHandlerID()
	{
	}

	/**
	 * Create a new instance of DeliveryNoteActionHandlerID.
	 ...
	 * <code>DeliveryNoteActionHandlerID newDeliveryNoteActionHandlerID = new DeliveryNoteActionHandlerID(oldDeliveryNoteActionHandlerID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public DeliveryNoteActionHandlerID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends DeliveryNoteActionHandlerID> clazz = this.getClass();
	 ...
	 * {@link #DeliveryNoteActionHandlerID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("deliveryNoteActionHandlerID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(deliveryNoteActionHandlerID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		DeliveryNoteActionHandlerID other = (DeliveryNoteActionHandlerID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(deliveryNoteActionHandlerID == null) {
			if(other.deliveryNoteActionHandlerID != null)
				return false;
		} else if(!deliveryNoteActionHandlerID.equals(other.deliveryNoteActionHandlerID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + ((deliveryNoteActionHandlerID == null) ? 0 : deliveryNoteActionHandlerID.hashCode());
		return result;
	}
	 ...
	 * @param deliveryNoteActionHandlerID The primary key field deliveryNoteActionHandlerID.
	 * @return a newly created instance of <code>DeliveryNoteActionHandlerID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static DeliveryNoteActionHandlerID create(String organisationID, String deliveryNoteActionHandlerID)
	{
		DeliveryNoteActionHandlerID n = new DeliveryNoteActionHandlerID();
		n.organisationID = organisationID;
		n.deliveryNoteActionHandlerID = deliveryNoteActionHandlerID;
		return n;
	}
}
