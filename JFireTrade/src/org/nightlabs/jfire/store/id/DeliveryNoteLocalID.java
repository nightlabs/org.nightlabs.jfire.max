...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.store.DeliveryNoteLocal}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class DeliveryNoteLocalID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.store.DeliveryNoteLocal}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field deliveryNoteIDPrefix.
	 * Declared as primary key field in {@link org.nightlabs.jfire.store.DeliveryNoteLocal}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String deliveryNoteIDPrefix;

	/**
	 * Primary key field deliveryNoteID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.store.DeliveryNoteLocal}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	...
	/**
	 * Create a new empty instance of DeliveryNoteLocalID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public DeliveryNoteLocalID()
	{
	}

	/**
	 * Create a new instance of DeliveryNoteLocalID.
	 ...
	 * <code>DeliveryNoteLocalID newDeliveryNoteLocalID = new DeliveryNoteLocalID(oldDeliveryNoteLocalID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public DeliveryNoteLocalID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends DeliveryNoteLocalID> clazz = this.getClass();
	 ...
	 * {@link #DeliveryNoteLocalID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("deliveryNoteIDPrefix="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(deliveryNoteIDPrefix), ENCODING));
			sb.append('&');
			sb.append("deliveryNoteID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(deliveryNoteID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		DeliveryNoteLocalID other = (DeliveryNoteLocalID) obj;
		...
		if(deliveryNoteIDPrefix == null) {
			if(other.deliveryNoteIDPrefix != null)
				return false;
		} else if(!deliveryNoteIDPrefix.equals(other.deliveryNoteIDPrefix))
			return false;
		if(deliveryNoteID != other.deliveryNoteID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + ((deliveryNoteIDPrefix == null) ? 0 : deliveryNoteIDPrefix.hashCode());
		result = prime * result + (int) (deliveryNoteID ^ (deliveryNoteID >>> 32));
		return result;
	}
	 ...
	 * @param deliveryNoteIDPrefix The primary key field deliveryNoteIDPrefix.
	 * @param deliveryNoteID The primary key field deliveryNoteID.
	 * @return a newly created instance of <code>DeliveryNoteLocalID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static DeliveryNoteLocalID create(String organisationID, String deliveryNoteIDPrefix, long deliveryNoteID)
	{
		DeliveryNoteLocalID n = new DeliveryNoteLocalID();
