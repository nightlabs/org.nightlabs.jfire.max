...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.store.ReceptionNoteLocal}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class ReceptionNoteLocalID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.store.ReceptionNoteLocal}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field receptionNoteIDPrefix.
	 * Declared as primary key field in {@link org.nightlabs.jfire.store.ReceptionNoteLocal}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String receptionNoteIDPrefix;

	/**
	 * Primary key field receptionNoteID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.store.ReceptionNoteLocal}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long receptionNoteID;

	/**
	 * Create a new empty instance of ReceptionNoteLocalID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ReceptionNoteLocalID()
	{
	}

	/**
	 * Create a new instance of ReceptionNoteLocalID.
	 ...
	 * <code>ReceptionNoteLocalID newReceptionNoteLocalID = new ReceptionNoteLocalID(oldReceptionNoteLocalID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ReceptionNoteLocalID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ReceptionNoteLocalID> clazz = this.getClass();
	 ...
	 * {@link #ReceptionNoteLocalID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("receptionNoteIDPrefix="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(receptionNoteIDPrefix), ENCODING));
			sb.append('&');
			sb.append("receptionNoteID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(receptionNoteID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ReceptionNoteLocalID other = (ReceptionNoteLocalID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(receptionNoteIDPrefix == null) {
			if(other.receptionNoteIDPrefix != null)
				return false;
		} else if(!receptionNoteIDPrefix.equals(other.receptionNoteIDPrefix))
			return false;
		if(receptionNoteID != other.receptionNoteID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + ((receptionNoteIDPrefix == null) ? 0 : receptionNoteIDPrefix.hashCode());
		result = prime * result + (int) (receptionNoteID ^ (receptionNoteID >>> 32));
		return result;
	}
	 ...
	 * @param receptionNoteIDPrefix The primary key field receptionNoteIDPrefix.
	 * @param receptionNoteID The primary key field receptionNoteID.
	 * @return a newly created instance of <code>ReceptionNoteLocalID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ReceptionNoteLocalID create(String organisationID, String receptionNoteIDPrefix, long receptionNoteID)
	{
		ReceptionNoteLocalID n = new ReceptionNoteLocalID();
		n.organisationID = organisationID;
		n.receptionNoteIDPrefix = receptionNoteIDPrefix;
		n.receptionNoteID = receptionNoteID;
		return n;
	}
}
