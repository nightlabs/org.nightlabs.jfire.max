...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.trade.config.IDPrefixCf}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class IDPrefixCfID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.trade.config.IDPrefixCf}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field idPrefixCfID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.trade.config.IDPrefixCf}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long idPrefixCfID;

	/**
	 * Create a new empty instance of IDPrefixCfID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public IDPrefixCfID()
	{
	...
	/**
	 * Create a new instance of IDPrefixCfID.
	 ...
	 * <code>IDPrefixCfID newIDPrefixCfID = new IDPrefixCfID(oldIDPrefixCfID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public IDPrefixCfID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends IDPrefixCfID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("idPrefixCfID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(idPrefixCfID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		IDPrefixCfID other = (IDPrefixCfID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(idPrefixCfID != other.idPrefixCfID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + (int) (idPrefixCfID ^ (idPrefixCfID >>> 32));
		return result;
	}
	 ...
	 * @param idPrefixCfID The primary key field idPrefixCfID.
	 * @return a newly created instance of <code>IDPrefixCfID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static IDPrefixCfID create(String organisationID, long idPrefixCfID)
	{
		IDPrefixCfID n = new IDPrefixCfID();
		n.organisationID = organisationID;
		n.idPrefixCfID = idPrefixCfID;
		return n;
	}
}
