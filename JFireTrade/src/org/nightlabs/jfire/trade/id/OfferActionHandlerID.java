...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.trade.OfferActionHandler}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class OfferActionHandlerID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.trade.OfferActionHandler}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field offerActionHandlerID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.trade.OfferActionHandler}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String offerActionHandlerID;

	/**
	 * Create a new empty instance of OfferActionHandlerID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public OfferActionHandlerID()
	{
	}

	/**
	 * Create a new instance of OfferActionHandlerID.
	 ...
	 * <code>OfferActionHandlerID newOfferActionHandlerID = new OfferActionHandlerID(oldOfferActionHandlerID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public OfferActionHandlerID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends OfferActionHandlerID> clazz = this.getClass();
	 ...
	 * {@link #OfferActionHandlerID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("offerActionHandlerID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(offerActionHandlerID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		OfferActionHandlerID other = (OfferActionHandlerID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(offerActionHandlerID == null) {
			if(other.offerActionHandlerID != null)
				return false;
		} else if(!offerActionHandlerID.equals(other.offerActionHandlerID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + ((offerActionHandlerID == null) ? 0 : offerActionHandlerID.hashCode());
		return result;
	}
	 ...
	 * @param offerActionHandlerID The primary key field offerActionHandlerID.
	 * @return a newly created instance of <code>OfferActionHandlerID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static OfferActionHandlerID create(String organisationID, String offerActionHandlerID)
	{
		OfferActionHandlerID n = new OfferActionHandlerID();
		n.organisationID = organisationID;
		n.offerActionHandlerID = offerActionHandlerID;
		return n;
	}
}
