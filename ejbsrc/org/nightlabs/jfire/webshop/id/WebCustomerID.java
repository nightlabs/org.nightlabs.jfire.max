 ...
 * {@link org.nightlabs.jfire.webshop.WebCustomer}.
 */
...
implements Serializable, org.nightlabs.jdo.ObjectID
{
	...
	/**
	 * This constructor creates a new instance of WebCustomerID
	 * by parsing the <code>keyStr</code> that has been created by {@link #toString()}
	 ...
	 */
	public WebCustomerID(String keyStr)
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof WebCustomerID))
			return false;
		...
		return
					...
					&&
					(
						(this.webCustomerID == other.webCustomerID) ||
						(this.webCustomerID != null && this.webCustomerID.equals(other.webCustomerID))
					)
			;
	}
	...
	public int hashCode()
	{
		return
					...
					^
					(webCustomerID == null ? 0 : webCustomerID.hashCode()) // Normally, it should never be null, but still it just happened to me! Marco.
			;
	}

	/**
	 * @return Returns a newly created instance of <code>WebCustomerID</code>
	 *		with the primary-key fields set to the given parameters.
	 */
	public static WebCustomerID create(
				java.lang.String organisationID,
				java.lang.String webCustomerID
		)
	{
