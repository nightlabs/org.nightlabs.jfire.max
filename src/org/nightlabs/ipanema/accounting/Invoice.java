 ...
 *		objectid-class="org.nightlabs.ipanema.accounting.id.InvoiceID"
 *		detachable="true"
...
//		this.desiredModeOfPaymentFlavour = desiredModeOfPaymentFlavour;
	 ...
	 *		value-type="org.nightlabs.ipanema.trade.Article"
	 *		mapped-by="invoice"
	 *
...
//	}
	...
	{
		Invoice attached = this;
		Invoice detached = (Invoice)_detached;
