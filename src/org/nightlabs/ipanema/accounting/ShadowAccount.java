 ...
 *		persistence-capable-superclass="org.nightlabs.ipanema.accounting.Account"
 *		detachable="true"
...
//			boolean isDebit = moneyTransfer.getTo().getPrimaryKey().equals(this.getPrimaryKey());
	...
	/**
	 * @see org.nightlabs.ipanema.accounting.Account#bookAccountMoneyTransfer(org.nightlabs.ipanema.security.User, org.nightlabs.ipanema.accounting.MoneyTransfer, java.util.Map)
	 */
