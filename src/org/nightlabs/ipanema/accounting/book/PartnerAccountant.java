 ...
 *
 */
package org.nightlabs.ipanema.accounting.book;
...
import org.nightlabs.ipanema.accounting.InvoiceMoneyTransfer;
 ...
 *		persistence-capable-superclass="org.nightlabs.ipanema.accounting.book.Accountant"
 *		detachable="true"
...
public class PartnerAccountant extends Accountant
{
	...
	/**
	 * @see org.nightlabs.ipanema.accounting.book.Accountant#bookTransfer(User, LegalEntity, MoneyTransfer, Map)
	 */
