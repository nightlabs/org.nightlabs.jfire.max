 ...
 * {@link org.nightlabs.ipanema.transfer.Anchor} (usually an
 * {@link org.nightlabs.ipanema.accounting.Account}) representing
 * a money source OUTSIDE the system. The other <tt>Anchor</tt> is a
 * {@link org.nightlabs.ipanema.trade.LegalEntity} representing the partner to whom
 * or from whom money is transferred.
 * <p>
 * In spite of other {@link org.nightlabs.ipanema.accounting.MoneyTransfer}s
 ...
 * can be assigned to a multiple of {@link org.nightlabs.ipanema.accounting.Invoice}
 * s.
 * <p>
