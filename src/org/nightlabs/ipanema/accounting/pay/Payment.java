 ...
 *		objectid-class="org.nightlabs.ipanema.accounting.pay.id.PaymentID"
 *		detachable="true"
...
implements Serializable, StoreCallback
{
	...
	/**
	 * A rollback has been done, but there was no {@link org.nightlabs.ipanema.accounting.pay.PayMoneyTransfer}
	...
	/**
	 * A rollback has been done and the {@link org.nightlabs.ipanema.accounting.pay.PayMoneyTransfer}
	 * including all dependent {@link org.nightlabs.ipanema.accounting.MoneyTransfer}s have
...
// The following fields are not transferred to the server - only their IDs are.	
	 ...
	 *		element-type="org.nightlabs.ipanema.accounting.Invoice"
