...
import org.nightlabs.ipanema.store.id.ProductReferenceGroupID;
import org.nightlabs.ipanema.store.id.ProductReferenceID;
 ...
 * {@link org.nightlabs.ipanema.store.deliver.Delivery} can deliver not-yet-existing
 * {@link org.nightlabs.ipanema.store.Product}s. If a {@link org.nightlabs.ipanema.store.Repository}
 * is used as the "from" of a {@link org.nightlabs.ipanema.store.ProductTransfer} where a
 * {@link org.nightlabs.ipanema.store.Product} does currently not exist, a <code>ProductReference</code>
 * is created.
 * <p>
 * The <code>ProductReference</code> is deleted, once the {@link org.nightlabs.ipanema.store.Product} is
 ...
 *		objectid-class="org.nightlabs.ipanema.store.id.ProductReferenceID"
 *		detachable="true"
 ...
 *		IMPORTS import org.nightlabs.ipanema.store.ProductReferenceGroup"
 */
