...
import org.nightlabs.ipanema.store.book.id.LocalStorekeeperDelegateID;
 ...
 * when necessary. This happens, when a {@link org.nightlabs.ipanema.store.ProductType}
 * does not have a <code>LocalStorekeeperDelegate</code> assigned during the booking of a
 * {@link org.nightlabs.ipanema.store.DeliveryNote}. In other words,
 * the method {@link org.nightlabs.ipanema.store.Store#bookDeliveryNote(User, DeliveryNote, boolean, boolean)}
 * automatically assigns the per-datastore-singleton of this class (using
 * {@link org.nightlabs.ipanema.store.ProductType#setLocalStorekeeperDelegate(LocalStorekeeperDelegate)}),
 * if {@link org.nightlabs.ipanema.store.ProductType#getLocalStorekeeperDelegate()} returns
 * <code>null</code>.
 * <p>
...
//	 * Hence, this method groups all {@link Article}s by {@link org.nightlabs.ipanema.store.ProductType}.
//	 * As this implementation of <code>LocalStorekeeperDelegate</code> manages one
//	 * {@link org.nightlabs.ipanema.store.Repository} per <code>ProductType</code>,
//	 * the method {@link #postBookArticles(OrganisationLegalEntity, User, DeliveryNote, BookProductTransfer, Map)} then
//	 * creates one {@link org.nightlabs.ipanema.store.ProductTransfer} per <code>ProductType</code>.
//	 * </p>
//	 * <p>
...
//	 * </p>
//	 *
//	 * @see org.nightlabs.ipanema.store.book.LocalStorekeeperDelegate#bookArticle(org.nightlabs.ipanema.trade.OrganisationLegalEntity, org.nightlabs.ipanema.security.User, org.nightlabs.ipanema.store.DeliveryNote, org.nightlabs.ipanema.trade.Article, org.nightlabs.ipanema.store.book.BookProductTransfer, java.util.Map)
//	 */

	/**
	 * This method does not yet book the <code>article</code>, but only groups all products by their
	 * {@link org.nightlabs.ipanema.store.ProductType}. The actual booking is done by
...
//			throw new IllegalStateException("mandator is neither 'from' nor 'to' of bookTransfer!");
	...
	/**
	 * This method generates one {@link ProductTransfer} per {@link org.nightlabs.ipanema.store.ProductType}
	 ...
	 * before.
	 *
	 * @see org.nightlabs.ipanema.store.book.LocalStorekeeperDelegate#postBookArticles(org.nightlabs.ipanema.trade.OrganisationLegalEntity, org.nightlabs.ipanema.security.User, org.nightlabs.ipanema.store.DeliveryNote, org.nightlabs.ipanema.store.book.BookProductTransfer, java.util.Map)
	 */
