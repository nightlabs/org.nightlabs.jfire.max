 ...
 * {@link org.nightlabs.ipanema.accounting.book.Accountant} does in the
 * accounting. This means, it is responsible for local transfers between
 * {@link org.nightlabs.ipanema.store.Repository}s when a
 * {@link org.nightlabs.ipanema.store.deliver.Delivery} is done.
 *
 * @author Marco Schulze - marco at nightlabs dot de
 *
 * @jdo.persistence-capable
 *		identity-type="application"
 *		objectid-class="org.nightlabs.ipanema.store.book.id.StorekeeperID"
 *		detachable="true"
