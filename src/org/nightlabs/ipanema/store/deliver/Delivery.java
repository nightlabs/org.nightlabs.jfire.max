...
import org.nightlabs.ipanema.trade.ArticleLocal;
 ...
 *		objectid-class="org.nightlabs.ipanema.store.deliver.id.DeliveryID"
 *		detachable="true"
...
implements Serializable, StoreCallback
{
	...
	/**
	 * A rollback has been done, but there was no {@link org.nightlabs.ipanema.store.deliver.DeliverMoneyTransfer}
	...
	/**
	 * A rollback has been done and the {@link org.nightlabs.ipanema.store.deliver.DeliverMoneyTransfer}
	 * including all dependent {@link org.nightlabs.ipanema.store.MoneyTransfer}s have
	 * been deleted. All involved anchors got previously informed by
	 * {@link org.nightlabs.ipanema.transfer.Anchor#rollbackTransfer(User, Transfer, Map)}.
	 * <p>
...
//	 *		element-type="org.nightlabs.ipanema.store.Product"
...
//	private Collection products = null;
	 ...
	 *		persistence-modifier="persistent"
	 *		collection-type="collection"
	 *		element-type="org.nightlabs.ipanema.trade.ArticleLocal"
	 *		mapped-by="delivery"
	 */	
	 ...
	 *		persistence-modifier="persistent"
	 *		collection-type="collection"
	 *		element-type="org.nightlabs.ipanema.store.DeliveryNote"
...
//	}
	...
	/**
	 * @return Returns instances of {@link org.nightlabs.ipanema.trade.id.ArticleID}.
	 */
	...
	/**
	 * @return Returns instances of {@link org.nightlabs.ipanema.trade.Article}.
	 */
	...
	/**
	 * @param articleIDs Instances of {@link org.nightlabs.ipanema.trade.id.ArticleID}
	 */
