...
import org.nightlabs.ipanema.accounting.book.Accountant;
...
import org.nightlabs.ipanema.store.ProductReference;
import org.nightlabs.ipanema.store.ProductTransfer;
import org.nightlabs.ipanema.store.book.Storekeeper;
...
//		}
	...
	protected void bookProductTransfer(ProductTransfer transfer, org.nightlabs.ipanema.security.User user, Map involvedAnchors)
	{
		if (storekeeper == null)
