 ...
 *		persistence-capable-superclass="org.nightlabs.ipanema.trade.LegalEntity"
 *		detachable="true"
...
//	private boolean localOrganisation;
	...
	public OrganisationLegalEntity(org.nightlabs.ipanema.organisation.Organisation organisation, String anchorTypeID)
	{
...
//		localOrganisation = localOrganisationID.equals(getOrganisationID());
	 ...
	 */
	private org.nightlabs.ipanema.organisation.Organisation organisation;

	/**
	 * @return Returns the organisation.
	 */
	public org.nightlabs.ipanema.organisation.Organisation getOrganisation()
	{
		return organisation;
	}
