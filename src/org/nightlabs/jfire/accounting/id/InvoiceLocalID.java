...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.accounting.InvoiceLocal}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class InvoiceLocalID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -2589313263643033763L;
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.InvoiceLocal}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field invoiceIDPrefix.
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.InvoiceLocal}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String invoiceIDPrefix;

	/**
	 * Primary key field invoiceID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.InvoiceLocal}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	...
	/**
	 * Create a new empty instance of InvoiceLocalID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public InvoiceLocalID()
	{
	}

	/**
	 * Create a new instance of InvoiceLocalID.
	 ...
	 * <code>InvoiceLocalID newInvoiceLocalID = new InvoiceLocalID(oldInvoiceLocalID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public InvoiceLocalID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends InvoiceLocalID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("invoiceIDPrefix="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(invoiceIDPrefix), ENCODING));
			sb.append('&');
			sb.append("invoiceID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(invoiceID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		InvoiceLocalID other = (InvoiceLocalID) obj;
		...
		if(invoiceIDPrefix == null) {
			if(other.invoiceIDPrefix != null)
				return false;
		} else if(!invoiceIDPrefix.equals(other.invoiceIDPrefix))
			return false;
	...
	public int hashCode()
	{
		...
		result = prime * result + ((invoiceIDPrefix == null) ? 0 : invoiceIDPrefix.hashCode());
	 ...
	 * @param invoiceIDPrefix The primary key field invoiceIDPrefix.
	 * @param invoiceID The primary key field invoiceID.
	 * @return a newly created instance of <code>InvoiceLocalID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static InvoiceLocalID create(String organisationID, String invoiceIDPrefix, long invoiceID)
	{
		InvoiceLocalID n = new InvoiceLocalID();
		n.organisationID = organisationID;
		n.invoiceIDPrefix = invoiceIDPrefix;
