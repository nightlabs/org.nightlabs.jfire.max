...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.accounting.ManualMoneyTransferReason}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class ManualMoneyTransferReasonID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.accounting.ManualMoneyTransferReason}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	...
	/**
	 * Create a new empty instance of ManualMoneyTransferReasonID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ManualMoneyTransferReasonID()
	{
	}

	/**
	 * Create a new instance of ManualMoneyTransferReasonID.
	 ...
	 * <code>ManualMoneyTransferReasonID newManualMoneyTransferReasonID = new ManualMoneyTransferReasonID(oldManualMoneyTransferReasonID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ManualMoneyTransferReasonID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ManualMoneyTransferReasonID> clazz = this.getClass();
	 ...
	 * {@link #ManualMoneyTransferReasonID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("transferTypeID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(transferTypeID), ENCODING));
			sb.append('&');
			sb.append("transferID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(transferID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ManualMoneyTransferReasonID other = (ManualMoneyTransferReasonID) obj;
		...
		if(transferTypeID == null) {
			if(other.transferTypeID != null)
				return false;
		} else if(!transferTypeID.equals(other.transferTypeID))
			return false;
	...
	public int hashCode()
	{
		...
		result = prime * result + ((transferTypeID == null) ? 0 : transferTypeID.hashCode());
		result = prime * result + (int) (transferID ^ (transferID >>> 32));
		return result;
	}
	 ...
	 * @param transferTypeID The primary key field transferTypeID.
	 * @param transferID The primary key field transferID.
	 * @return a newly created instance of <code>ManualMoneyTransferReasonID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ManualMoneyTransferReasonID create(String organisationID, String transferTypeID, long transferID)
	{
		ManualMoneyTransferReasonID n = new ManualMoneyTransferReasonID();
