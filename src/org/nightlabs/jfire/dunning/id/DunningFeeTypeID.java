...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.dunning.DunningFeeType}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class DunningFeeTypeID
implements Serializable, ObjectID
{
	...
	/**
	 * Create a new instance of DunningFeeTypeID.
	 ...
	 * <code>DunningFeeTypeID newDunningFeeTypeID = new DunningFeeTypeID(oldDunningFeeTypeID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public DunningFeeTypeID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends DunningFeeTypeID> clazz = this.getClass();
	...
	public String toString() 
	{
		...
		try {
			...
			sb.append('&');
			sb.append("feeTypeID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(feeTypeID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		DunningFeeTypeID other = (DunningFeeTypeID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(feeTypeID != other.feeTypeID)
			return false;
		return true;
	}
	 ...
	 * @param feeTypeID The primary key field feeTypeID.
	 * @return a newly created instance of <code>DunningFeeTypeID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static DunningFeeTypeID create(String organisationID, long feeTypeID)
	{
		DunningFeeTypeID n = new DunningFeeTypeID();
		n.organisationID = organisationID;
		n.feeTypeID = feeTypeID;
		return n;
	}
}
