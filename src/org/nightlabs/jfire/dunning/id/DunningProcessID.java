...
implements ObjectID
{
	...
	/**
	 * Primary key field dunningProcessID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.dunning.DunningProcess}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String dunningProcessID;
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("dunningProcessID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(dunningProcessID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public int hashCode()
	{
		...
		result = prime * result + ((dunningProcessID == null) ? 0 : dunningProcessID.hashCode());
		return result;
	}
