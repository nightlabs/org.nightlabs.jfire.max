...
import org.nightlabs.jfire.dynamictrade.template.id.DynamicProductTemplateProductNameID;
 ...
 */
@PersistenceCapable(
	objectIdClass=DynamicProductTemplateProductNameID.class,
	identityType=IdentityType.APPLICATION,
	detachable="true",
	table="JFireDynamicTrade_DynamicProductTemplateProductName")
@FetchGroups({
	@FetchGroup(
...
extends I18nText
{
	...
	@Persistent(
		...
		table="JFireDynamicTrade_DynamicProductTemplateProductName_names",
	 ...
	 */
	@Deprecated
	protected DynamicProductTemplateProductName()
	{
	}

	public DynamicProductTemplateProductName(DynamicProductTemplate dynamicProductTemplate)
	{
