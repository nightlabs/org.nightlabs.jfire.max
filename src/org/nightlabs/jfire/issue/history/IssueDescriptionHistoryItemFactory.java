...
/**
 * This is the {@link IssueHistoryItemFactory} that generates {@link IssueDescriptionHistoryItem}s, based on information
 * between an old {@link Issue} and a newly saved {@link Issue}.
 *
 * @author Khaireel Mohamed - khaireel at nightlabs dot de
 */
public class IssueDescriptionHistoryItemFactory extends I18nTextIssueHistoryItemFactory {
	/* (non-Javadoc)
	...
	protected IssueHistoryItem createIssueHistoryItem(User user, Issue issue, String languageID, String oldValue, String newValue) {
		return new IssueDescriptionHistoryItem(user, issue, languageID, oldValue, newValue);
	}
