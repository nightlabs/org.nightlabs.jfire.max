...
public class IssueLinkHistoryItem extends IssueHistoryItem {
	 ...
	 */
	public IssueLinkHistoryItem(User user, Issue issue, IssueLinkType issueLinkType, IssueHistoryItemAction issueHistoryItemAction, String linkedObjectClassName, String linkedObjectID) {
