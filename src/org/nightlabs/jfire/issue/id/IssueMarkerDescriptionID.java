...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.issue.issueMarker.IssueMarkerDescription}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class IssueMarkerDescriptionID
implements Serializable, ObjectID
{
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -217618346L;
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.issue.issueMarker.IssueMarkerDescription}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	...
	/**
	 * Create a new empty instance of IssueMarkerDescriptionID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public IssueMarkerDescriptionID()
	{
	}

	/**
	 * Create a new instance of IssueMarkerDescriptionID.
	 ...
	 * <code>IssueMarkerDescriptionID newIssueMarkerDescriptionID = new IssueMarkerDescriptionID(oldIssueMarkerDescriptionID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public IssueMarkerDescriptionID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends IssueMarkerDescriptionID> clazz = this.getClass();
	 ...
	 * {@link #IssueMarkerDescriptionID(String)}.
	...
	public String toString()
	{
		...
		try {
			sb.append("issueMarkerID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(issueMarkerID, RADIX), ENCODING));
			sb.append('&');
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		IssueMarkerDescriptionID other = (IssueMarkerDescriptionID) obj;
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + (int) (issueMarkerID ^ (issueMarkerID >>> 32));
	 ...
	 * @param issueMarkerID The primary key field issueMarkerID.
	 * @param organisationID The primary key field organisationID.
	 * @return a newly created instance of <code>IssueMarkerDescriptionID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static IssueMarkerDescriptionID create(long issueMarkerID, String organisationID)
	{
		IssueMarkerDescriptionID n = new IssueMarkerDescriptionID();
		n.issueMarkerID = issueMarkerID;
