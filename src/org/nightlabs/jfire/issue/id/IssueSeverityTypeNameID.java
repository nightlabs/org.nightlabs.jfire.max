...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.issue.IssueSeverityTypeName}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class IssueSeverityTypeNameID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.issue.IssueSeverityTypeName}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field issueSeverityTypeID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.issue.IssueSeverityTypeName}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String issueSeverityTypeID;

	/**
	 * Create a new empty instance of IssueSeverityTypeNameID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public IssueSeverityTypeNameID()
	{
	}

	/**
	 * Create a new instance of IssueSeverityTypeNameID.
	 ...
	 * <code>IssueSeverityTypeNameID newIssueSeverityTypeNameID = new IssueSeverityTypeNameID(oldIssueSeverityTypeNameID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public IssueSeverityTypeNameID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends IssueSeverityTypeNameID> clazz = this.getClass();
	 ...
	 * {@link #IssueSeverityTypeNameID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("issueSeverityTypeID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(issueSeverityTypeID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		IssueSeverityTypeNameID other = (IssueSeverityTypeNameID) obj;
		...
		if(issueSeverityTypeID == null) {
			if(other.issueSeverityTypeID != null)
				return false;
		} else if(!issueSeverityTypeID.equals(other.issueSeverityTypeID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + ((issueSeverityTypeID == null) ? 0 : issueSeverityTypeID.hashCode());
		return result;
	}
	 ...
	 * @param issueSeverityTypeID The primary key field issueSeverityTypeID.
	 * @return a newly created instance of <code>IssueSeverityTypeNameID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static IssueSeverityTypeNameID create(String organisationID, String issueSeverityTypeID)
	{
		IssueSeverityTypeNameID n = new IssueSeverityTypeNameID();
		n.organisationID = organisationID;
		n.issueSeverityTypeID = issueSeverityTypeID;
		return n;
	}
}
