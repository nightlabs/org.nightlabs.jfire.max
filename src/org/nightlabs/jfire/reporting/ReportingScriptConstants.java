...
public class ReportingScriptConstants {
	 ...
	 */
	public static String SCRIPT_REGISTRY_ITEM_TYPE_PROPERTY_SET = "JFireReporting-Scripting-PropertySet";
	/**
	 * The item id for the {@link PropertySet} script.
	 */
	private static String _SCRIPT_REGISTRY_ITEM_ID_PROPERTY_SET = "PropertySet";

	/**
	 * The {@link ScriptRegistryItemID} for the {@link PropertySet} script.
	 */
	public static ScriptRegistryItemID SCRIPT_REGISTRY_ITEM_ID_PROPERTY_SET = ScriptRegistryItemID.create(
