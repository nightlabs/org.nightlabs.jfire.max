...
/**
 * Helper class to initialize report layouts. The ReportInitializer will
 ...
 * <ul>
 * <li><b>Create the initializer</b>: Use {@link #ReportInitializer(String, ReportCategory, String, JFireServerManager, PersistenceManager, String)} to create the initializer and set the
...
public class ReportInitializer {
	...
	/**
	 * Creates a new ReportInitializer with the given parameters.
	 * 
