...
package org.nightlabs.jfire.reporting.layout.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.reporting.layout.ReportLayoutLocalisationData}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class ReportLayoutLocalisationDataID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -2512417091720960945L;
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.layout.ReportLayoutLocalisationData}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field reportRegistryItemType.
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.layout.ReportLayoutLocalisationData}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String reportRegistryItemType;

	/**
	 * Primary key field reportRegistryItemID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.layout.ReportLayoutLocalisationData}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String reportRegistryItemID;

	/**
	 * Primary key field locale.
	 * Declared as primary key field in {@link org.nightlabs.jfire.reporting.layout.ReportLayoutLocalisationData}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	...
	/**
	 * Create a new empty instance of ReportLayoutLocalisationDataID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ReportLayoutLocalisationDataID()
	{
	}

	/**
	 * Create a new instance of ReportLayoutLocalisationDataID.
	 ...
	 * <code>ReportLayoutLocalisationDataID newReportLayoutLocalisationDataID = new ReportLayoutLocalisationDataID(oldReportLayoutLocalisationDataID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ReportLayoutLocalisationDataID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ReportLayoutLocalisationDataID> clazz = this.getClass();
	 ...
	 * {@link #ReportLayoutLocalisationDataID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("reportRegistryItemType="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(reportRegistryItemType), ENCODING));
			sb.append('&');
			sb.append("reportRegistryItemID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(reportRegistryItemID), ENCODING));
			sb.append('&');
			sb.append("locale="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(locale), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ReportLayoutLocalisationDataID other = (ReportLayoutLocalisationDataID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(reportRegistryItemType == null) {
			if(other.reportRegistryItemType != null)
				return false;
		} else if(!reportRegistryItemType.equals(other.reportRegistryItemType))
			return false;
		if(reportRegistryItemID == null) {
			if(other.reportRegistryItemID != null)
				return false;
		} else if(!reportRegistryItemID.equals(other.reportRegistryItemID))
			return false;
		if(locale == null) {
	...
	public int hashCode()
	{
		...
		result = prime * result + ((reportRegistryItemType == null) ? 0 : reportRegistryItemType.hashCode());
		result = prime * result + ((reportRegistryItemID == null) ? 0 : reportRegistryItemID.hashCode());
	 ...
	 * @param reportRegistryItemType The primary key field reportRegistryItemType.
	 * @param reportRegistryItemID The primary key field reportRegistryItemID.
	 * @param locale The primary key field locale.
	 * @return a newly created instance of <code>ReportLayoutLocalisationDataID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ReportLayoutLocalisationDataID create(String organisationID, String reportRegistryItemType, String reportRegistryItemID, String locale)
	{
		ReportLayoutLocalisationDataID n = new ReportLayoutLocalisationDataID();
		n.organisationID = organisationID;
		n.reportRegistryItemType = reportRegistryItemType;
		n.reportRegistryItemID = reportRegistryItemID;
		n.locale = locale;
		return n;
	}
}
