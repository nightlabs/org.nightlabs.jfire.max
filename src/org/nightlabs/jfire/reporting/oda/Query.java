...
//			paramNames.add(paramName);
	 ...
	 */
	public void setProperty(String name, String value) throws JFireOdaException {
	 ...
	 */
	public int getMaxRows() throws JFireOdaException {
		return maxRows;
	}
	 ...
	 */
	public void clearInParameters() throws JFireOdaException {
		clearParameters();
	}
	 ...
	 */
	public void setInt(String parameterName, int value) throws JFireOdaException {
	 ...
	 */
	public void setInt(int parameterId, int value) throws JFireOdaException {
	 ...
	 */
	public void setDouble(String parameterName, double value) throws JFireOdaException {
	 ...
	 */
	public void setDouble(int parameterId, double value) throws JFireOdaException {
	 ...
	 */
	public void setBigDecimal(String parameterName, BigDecimal value) throws JFireOdaException {
	 ...
	 */
	public void setBigDecimal(int parameterId, BigDecimal value) throws JFireOdaException {
	 ...
	 */
	public void setString(String parameterName, String value) throws JFireOdaException {
	 ...
	 */
	public void setString(int parameterId, String value) throws JFireOdaException {
		setParameter(parameterId, value);
	}

	/**
	 * Puts a parameter of type java.util.Date
	 * @see org.eclipse.datatools.connectivity.oda.jfire.IQuery#setDate(java.lang.String, java.sql.Date)
	 */
	public void setDate(String parameterName, Date value) throws JFireOdaException {
	 ...
	 */
	public void setDate(int parameterId, Date value) throws JFireOdaException {
		setParameter(parameterId, new java.util.Date(value.getTime()));
	}

	/**
	 * Puts a parameter of type java.util.Date
	 * @see org.eclipse.datatools.connectivity.oda.jfire.IQuery#setTime(java.lang.String, java.sql.Time)
	 */
	public void setTime(String parameterName, Time value) throws JFireOdaException {
	 ...
	 */
	public void setTime(int parameterId, Time value) throws JFireOdaException {
		setParameter(parameterId, new java.util.Date(value.getTime()));
	}

	/**
	 * Puts a parameter of type java.util.Date
	 * @see org.eclipse.datatools.connectivity.oda.jfire.IQuery#setTimestamp(java.lang.String, java.sql.Timestamp)
	 */
	public void setTimestamp(String parameterName, Timestamp value) throws JFireOdaException {
	 ...
	 */
	public void setTimestamp(int parameterId, Timestamp value) throws JFireOdaException {
		setParameter(parameterId, new java.util.Date(value.getTime()));
	}

	/**
	 * Puts a parameter of type boolean
	 * @see org.eclipse.datatools.connectivity.oda.jfire.IQuery#setBoolean(java.lang.String, boolean)
	 */
	public void setBoolean(String parameterName, boolean value) throws JFireOdaException {
	 ...
	 */
	public void setBoolean(int parameterId, boolean value) throws JFireOdaException {
		setParameter(parameterId, value);
	}

	/**
	 * Puts a parameter of value <code>null</code>.
	 * @see org.eclipse.datatools.connectivity.oda.jfire.IQuery#setNull(java.lang.String)
	 */
	public void setNull(String parameterName) throws JFireOdaException {
	 ...
	 */
	public void setNull(int parameterId) throws JFireOdaException {
	 ...
	 */
	public int findInParameter(String parameterName) throws JFireOdaException {
		return getParameterID(parameterName);
	}
	
	@Override
	public void setObject(int index, Object obj) throws JFireOdaException {
		setParameter(index, obj);
	}
	
	@Override
	public void setObject(String parameterName, Object obj) throws JFireOdaException {
		setParameter(parameterName, obj);
	}
	 ...
	 * 
	 * @see org.eclipse.datatools.connectivity.oda.jfire.IQuery#getParameterMetaData()
	 */
