...
import org.nightlabs.jfire.reporting.parameter.id.ValueProviderDescriptionID;
 ...
 *		objectid-class="org.nightlabs.jfire.reporting.parameter.id.ValueProviderDescriptionID"
 *		detachable="true"
 *		table="JFireReporting_ValueProviderDescription"
 *
 ...
 */@PersistenceCapable(
	objectIdClass=ValueProviderDescriptionID.class,
...
public class ValueProviderDescription extends I18nText implements Serializable {
	 ...
	 */
	@Deprecated
	protected ValueProviderDescription() {
	}

	public ValueProviderDescription(ValueProvider valueProvider) {
	 ...
	 *		table="JFireReporting_ValueProviderDescription_names"
