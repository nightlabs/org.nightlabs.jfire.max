...
import org.nightlabs.jfire.reporting.scheduled.ScheduledReportName;


/**
 * The JDO object id class for {@link ScheduledReportName}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class ScheduledReportNameID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link ScheduledReportName}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field scheduledReportID.
	 * Declared as primary key field in {@link ScheduledReportName}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	...
	/**
	 * Create a new empty instance of {@link ScheduledReportNameID}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ScheduledReportNameID()
	{
	}

	/**
	 * Create a new instance of ScheduledReportNameID.
	 ...
	 * <code>ScheduledReportNameID newScheduledReportNameID = new ScheduledReportNameID(oldScheduledReportNameID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ScheduledReportNameID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ScheduledReportNameID> clazz = this.getClass();
	 ...
	 * {@link #ScheduledReportNameID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("scheduledReportID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(scheduledReportID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ScheduledReportNameID other = (ScheduledReportNameID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(scheduledReportID != other.scheduledReportID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + (int) (scheduledReportID ^ (scheduledReportID >>> 32));
		return result;
	}
	 ...
	 * @param scheduledReportID The primary key field scheduledReportID.
	 * @return a newly created instance of <code>ScheduledReportNameID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ScheduledReportNameID create(String organisationID, long scheduledReportID)
	{
		ScheduledReportNameID n = new ScheduledReportNameID();
		n.organisationID = organisationID;
		n.scheduledReportID = scheduledReportID;
		return n;
	}

	public static ScheduledReportNameID create(ScheduledReportName scheduledReportName)
	{
		ScheduledReportNameID n = new ScheduledReportNameID();
		n.organisationID = scheduledReportName.getOrganisationID();
		n.scheduledReportID = scheduledReportName.getScheduledReportID();
		return n;
	}
}
