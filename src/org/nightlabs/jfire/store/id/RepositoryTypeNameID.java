...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.store.RepositoryTypeName}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class RepositoryTypeNameID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.store.RepositoryTypeName}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field repositoryTypeID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.store.RepositoryTypeName}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String repositoryTypeID;

	/**
	 * Create a new empty instance of RepositoryTypeNameID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public RepositoryTypeNameID()
	{
	}

	/**
	 * Create a new instance of RepositoryTypeNameID.
	 ...
	 * <code>RepositoryTypeNameID newRepositoryTypeNameID = new RepositoryTypeNameID(oldRepositoryTypeNameID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public RepositoryTypeNameID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends RepositoryTypeNameID> clazz = this.getClass();
	 ...
	 * {@link #RepositoryTypeNameID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("repositoryTypeID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(repositoryTypeID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		RepositoryTypeNameID other = (RepositoryTypeNameID) obj;
		...
		if(repositoryTypeID == null) {
			if(other.repositoryTypeID != null)
				return false;
		} else if(!repositoryTypeID.equals(other.repositoryTypeID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + ((repositoryTypeID == null) ? 0 : repositoryTypeID.hashCode());
		return result;
	}
	 ...
	 * @param repositoryTypeID The primary key field repositoryTypeID.
	 * @return a newly created instance of <code>RepositoryTypeNameID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static RepositoryTypeNameID create(String organisationID, String repositoryTypeID)
	{
		RepositoryTypeNameID n = new RepositoryTypeNameID();
		n.organisationID = organisationID;
		n.repositoryTypeID = repositoryTypeID;
		return n;
	}
}
