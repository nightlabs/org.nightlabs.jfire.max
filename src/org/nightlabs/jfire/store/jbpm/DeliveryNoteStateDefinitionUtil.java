...
//	public static final StateDefinitionID STATE_DEFINITION_ID_FINALIZED = StateDefinitionID.create(Organisation.DEVIL_ORGANISATION_ID, StateDefinitionConstantsDeliveryNote.class.getName(), "finalized");
//	public static final StateDefinitionID STATE_DEFINITION_ID_BOOKED = StateDefinitionID.create(Organisation.DEVIL_ORGANISATION_ID, StateDefinitionConstantsDeliveryNote.class.getName(), "booked");
//	public static final StateDefinitionID STATE_DEFINITION_ID_CANCELLED = StateDefinitionID.create(Organisation.DEVIL_ORGANISATION_ID, StateDefinitionConstantsDeliveryNote.class.getName(), "cancelled");
//
