...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.trade.OfferRequirement}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class OfferRequirementID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.trade.OfferRequirement}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field offerIDPrefix.
	 * Declared as primary key field in {@link org.nightlabs.jfire.trade.OfferRequirement}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String offerIDPrefix;

	/**
	 * Primary key field offerID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.trade.OfferRequirement}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long offerID;
	...
	/**
	 * Create a new empty instance of OfferRequirementID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public OfferRequirementID()
	{
	}

	/**
	 * Create a new instance of OfferRequirementID.
	 ...
	 * <code>OfferRequirementID newOfferRequirementID = new OfferRequirementID(oldOfferRequirementID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public OfferRequirementID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends OfferRequirementID> clazz = this.getClass();
	 ...
	 * {@link #OfferRequirementID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("offerIDPrefix="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(offerIDPrefix), ENCODING));
			sb.append('&');
			sb.append("offerID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(offerID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		OfferRequirementID other = (OfferRequirementID) obj;
		...
		if(offerIDPrefix == null) {
			if(other.offerIDPrefix != null)
				return false;
		} else if(!offerIDPrefix.equals(other.offerIDPrefix))
			return false;
	...
	public int hashCode()
	{
		...
		result = prime * result + ((offerIDPrefix == null) ? 0 : offerIDPrefix.hashCode());
	 ...
	 * @param offerIDPrefix The primary key field offerIDPrefix.
	 * @param offerID The primary key field offerID.
	 * @return a newly created instance of <code>OfferRequirementID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static OfferRequirementID create(String organisationID, String offerIDPrefix, long offerID)
	{
		OfferRequirementID n = new OfferRequirementID();
		n.organisationID = organisationID;
		n.offerIDPrefix = offerIDPrefix;
		n.offerID = offerID;
		return n;
	}
}
