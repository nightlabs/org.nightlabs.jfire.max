...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.trade.OrderRequirement}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class OrderRequirementID
implements ObjectID
{
	/**
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.trade.OrderRequirement}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;

	/**
	 * Primary key field orderIDPrefix.
	 * Declared as primary key field in {@link org.nightlabs.jfire.trade.OrderRequirement}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String orderIDPrefix;
	...
	/**
	 * Create a new empty instance of OrderRequirementID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public OrderRequirementID()
	{
	}

	/**
	 * Create a new instance of OrderRequirementID.
	 ...
	 * <code>OrderRequirementID newOrderRequirementID = new OrderRequirementID(oldOrderRequirementID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public OrderRequirementID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends OrderRequirementID> clazz = this.getClass();
	 ...
	 * {@link #OrderRequirementID(String)}.
	...
	public String toString()
	{
		...
		try {
			...
			sb.append('&');
			sb.append("orderIDPrefix="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(orderIDPrefix), ENCODING));
			sb.append('&');
			sb.append("orderID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(orderID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		OrderRequirementID other = (OrderRequirementID) obj;
		...
		if(orderIDPrefix == null) {
			if(other.orderIDPrefix != null)
				return false;
		} else if(!orderIDPrefix.equals(other.orderIDPrefix))
			return false;
	...
	public int hashCode()
	{
		...
		result = prime * result + ((orderIDPrefix == null) ? 0 : orderIDPrefix.hashCode());
	 ...
	 * @param orderIDPrefix The primary key field orderIDPrefix.
	 * @param orderID The primary key field orderID.
	 * @return a newly created instance of <code>OrderRequirementID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static OrderRequirementID create(String organisationID, String orderIDPrefix, long orderID)
	{
		OrderRequirementID n = new OrderRequirementID();
		n.organisationID = organisationID;
		n.orderIDPrefix = orderIDPrefix;
		n.orderID = orderID;
		return n;
	}
}
