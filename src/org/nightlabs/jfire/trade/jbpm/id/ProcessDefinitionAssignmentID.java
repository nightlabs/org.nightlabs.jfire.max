...
package org.nightlabs.jfire.trade.jbpm.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.trade.jbpm.ProcessDefinitionAssignment}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class ProcessDefinitionAssignmentID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -1465989372L;
	...
	/**
	 * Primary key field statableClass.
	 * Declared as primary key field in {@link org.nightlabs.jfire.trade.jbpm.ProcessDefinitionAssignment}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String statableClass;

	/**
	 * Primary key field tradeSide.
	 * Declared as primary key field in {@link org.nightlabs.jfire.trade.jbpm.ProcessDefinitionAssignment}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String tradeSide;

	/**
	 * Create a new empty instance of ProcessDefinitionAssignmentID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ProcessDefinitionAssignmentID()
	{
	}

	/**
	 * Create a new instance of ProcessDefinitionAssignmentID.
	 ...
	 * <code>ProcessDefinitionAssignmentID newProcessDefinitionAssignmentID = new ProcessDefinitionAssignmentID(oldProcessDefinitionAssignmentID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public ProcessDefinitionAssignmentID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends ProcessDefinitionAssignmentID> clazz = this.getClass();
	 ...
	 * {@link #ProcessDefinitionAssignmentID(String)}.
	...
	public String toString()
	{
		...
		try {
			sb.append("statableClass="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(statableClass), ENCODING));
			sb.append('&');
			sb.append("tradeSide="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(tradeSide), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		ProcessDefinitionAssignmentID other = (ProcessDefinitionAssignmentID) obj;
		if(statableClass == null) {
			if(other.statableClass != null)
				return false;
		} else if(!statableClass.equals(other.statableClass))
			return false;
		if(tradeSide == null) {
			if(other.tradeSide != null)
				return false;
		} else if(!tradeSide.equals(other.tradeSide))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + ((statableClass == null) ? 0 : statableClass.hashCode());
	 ...
	 * @param statableClass The primary key field statableClass.
	 * @param tradeSide The primary key field tradeSide.
	 * @return a newly created instance of <code>ProcessDefinitionAssignmentID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static ProcessDefinitionAssignmentID create(String statableClass, String tradeSide)
	{
		ProcessDefinitionAssignmentID n = new ProcessDefinitionAssignmentID();
		n.statableClass = statableClass;
		n.tradeSide = tradeSide;
		return n;
	}
