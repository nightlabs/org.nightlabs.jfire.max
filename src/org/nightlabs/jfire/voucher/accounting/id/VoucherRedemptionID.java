...
package org.nightlabs.jfire.voucher.accounting.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.voucher.accounting.VoucherRedemption}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class VoucherRedemptionID
implements Serializable
{
	 ...
	 * Declared as primary key field in {@link org.nightlabs.jfire.voucher.accounting.VoucherRedemption}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String organisationID;
	
	/**
	 * Primary key field voucherRedemptionID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.voucher.accounting.VoucherRedemption}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long voucherRedemptionID;
	
	/**
	 * Create a new empty instance of VoucherRedemptionID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public VoucherRedemptionID()
	{
	}

	/**
	 * Create a new instance of VoucherRedemptionID.
	 ...
	 * <code>VoucherRedemptionID newVoucherRedemptionID = new VoucherRedemptionID(oldVoucherRedemptionID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public VoucherRedemptionID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends VoucherRedemptionID> clazz = this.getClass();
	 ...
	 * {@link #VoucherRedemptionID(String)}.
	...
	public String toString() 
	{
		...
		try {
			...
			sb.append('&');
			sb.append("voucherRedemptionID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(voucherRedemptionID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		VoucherRedemptionID other = (VoucherRedemptionID) obj;
		if(organisationID == null) {
			if(other.organisationID != null)
				return false;
		} else if(!organisationID.equals(other.organisationID))
			return false;
		if(voucherRedemptionID != other.voucherRedemptionID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		...
		result = prime * result + (int) (voucherRedemptionID ^ (voucherRedemptionID >>> 32));
		return result;
	}
	 ...
	 * @param voucherRedemptionID The primary key field voucherRedemptionID.
	 * @return a newly created instance of <code>VoucherRedemptionID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static VoucherRedemptionID create(String organisationID, long voucherRedemptionID)
	{
		VoucherRedemptionID n = new VoucherRedemptionID();
		n.organisationID = organisationID;
		n.voucherRedemptionID = voucherRedemptionID;
		return n;
	}
}
