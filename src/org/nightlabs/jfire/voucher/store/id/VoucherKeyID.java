...
package org.nightlabs.jfire.voucher.store.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jfire.voucher.store.VoucherKey}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class VoucherKeyID
implements Serializable
{
	 ...
	 */ 
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -5021895157293488553L;
	...
	/**
	 * Primary key field voucherOrganisationID.
	 * Declared as primary key field in {@link org.nightlabs.jfire.voucher.store.VoucherKey}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public int voucherOrganisationID;
	
	/**
	 * Primary key field voucherNumber.
	 * Declared as primary key field in {@link org.nightlabs.jfire.voucher.store.VoucherKey}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	...
	/**
	 * Create a new empty instance of VoucherKeyID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public VoucherKeyID()
	{
	...
	/**
	 * Create a new instance of VoucherKeyID.
	 ...
	 * <code>VoucherKeyID newVoucherKeyID = new VoucherKeyID(oldVoucherKeyID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public VoucherKeyID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends VoucherKeyID> clazz = this.getClass();
	...
	public String toString() 
	{
		...
		try {
			sb.append("voucherOrganisationID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Integer.toString(voucherOrganisationID, RADIX), ENCODING));
			sb.append('&');
			sb.append("voucherNumber="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(voucherNumber, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		VoucherKeyID other = (VoucherKeyID) obj;
		if(voucherOrganisationID != other.voucherOrganisationID)
			return false;
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + voucherOrganisationID;
		result = prime * result + (int) (voucherNumber ^ (voucherNumber >>> 32));
		return result;
	}

	/**
	 * Create a new object id instance.
	 * @param voucherOrganisationID The primary key field voucherOrganisationID.
	 * @param voucherNumber The primary key field voucherNumber.
	 * @return a newly created instance of <code>VoucherKeyID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static VoucherKeyID create(int voucherOrganisationID, long voucherNumber)
	{
		VoucherKeyID n = new VoucherKeyID();
		n.voucherOrganisationID = voucherOrganisationID;
		n.voucherNumber = voucherNumber;
		return n;
	}
}
